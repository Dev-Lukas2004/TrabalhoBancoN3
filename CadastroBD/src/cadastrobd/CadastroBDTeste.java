...
public class CadastroBDTeste {
    ...
    private void run() {
        PessoaFisica pf = new PessoaFisica(1, "Lukas Cauã", "Rua teste, 21", "Rio de Janeiro",
            "RJ", "0000-0000", "lukascaua@gmail.com", "92809856743");
        ...
        PessoaJuridica pj = new PessoaJuridica(2, "SuperMarket","Rua RE, 90 Bairro: São Joao", "Rio de Janeiro",
            "RJ", "2222-3333", "supermarkt@hotmail.com", "44012616000158");
